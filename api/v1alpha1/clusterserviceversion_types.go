...
import (
	...
	"github.com/buptGophers/operator-manager/api/lib/version"
)

const (
	ClusterServiceVersionAPIVersion     = GroupName + "/" + GroupVersionString
...
func init() {
	SchemeBuilder.Register(&ClusterServiceVersion{}, &ClusterServiceVersionList{})
}
