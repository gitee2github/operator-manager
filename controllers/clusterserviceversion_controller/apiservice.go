...
//func (r *ClusterServiceVersionReconciler) deleteLegacyAPIServiceResources(csv *v1alpha1.ClusterServiceVersion, desc apiServiceDescriptionsWithCAPEM) error {
//	logger := log.WithFields(log.Fields{
//		"ownerName":      csv.GetName(),
//		"ownerNamespace": csv.GetNamespace(),
//		"ownerKind":      csv.GetObjectKind().GroupVersionKind().GroupKind().Kind,
//	})
//	namespace := csv.GetNamespace()
...
//		existingService, err := r.Client.Get(context.TODO(), namespace, legacyServiceName)
//		if err != nil {
//			if !k8serrors.IsNotFound(err) {
//				return err
//			}
