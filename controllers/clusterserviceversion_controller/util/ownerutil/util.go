...
import (
	...
	operatorsv1 "github.com/buptGophers/operator-manager/api/v1"
	operatorsv1alpha1 "github.com/buptGophers/operator-manager/api/v1alpha1"
)
...
func InferGroupVersionKind(obj runtime.Object) error {
	...
	case *operatorsv1.BluePrint:
		objectKind.SetGroupVersionKind(schema.GroupVersionKind{
			Group:   operatorsv1alpha1.GroupName,
			Version: "v1",
			Kind:    operatorsv1alpha1.InstallPlanKind,
		})
	case *operatorsv1.Subscription:
		objectKind.SetGroupVersionKind(schema.GroupVersionKind{
			Group:   operatorsv1alpha1.GroupName,
			Version: "v1",
